...
async function resourcesProjectOperation() {
    await sleep(1000);
    await login();
    ...
    (await waitVisibleEle(By.xpath("/html/body/div[1]/section/aside/div/div/ul/li[5]/ul/li[6]/ul/li[1]"))).click();
    ...
    await driver.findElement(By.xpath(`/html/body/div[1]/section/section/main/div/div[1]/div[2]/div/div[2]/div[2]/div[2]/div[2]/div/div/span[1]/input`)).click();
    ...
    await driver.findElement(By.xpath(`/html/body/div[1]/section/section/main/div/div[1]/div[2]/div/div[2]/div[2]/div[3]/div[2]/div/div`)).click();
    (await waitVisibleEle(By.xpath("/html/body/div[1]/section/section/main/div/div[2]/div[4]/div/div/div/div[2]/div[1]/div/div/div[1]/div"))).click();
    await driver.findElement(By.xpath(`/html/body/div[1]/section/section/main/div/div[1]/div[2]/div/div[2]/div[2]/div[4]/div[2]/input`)).sendKeys(itemName);
    await driver.findElement(By.xpath("/html/body/div[1]/section/section/main/div/div[1]/div[2]/div/div[2]/div[2]/div[5]/div[2]/div/div[2]/input")).sendKeys(100);
    await driver.findElement(By.xpath(`/html/body/div[1]/section/section/main/div/div[1]/div[2]/div/div[2]/div[2]/div[6]/div[2]/textarea`)).sendKeys(itemName);
    ...
    //删除
    await sleep(1000);
    await driver.findElement(By.xpath("/html/body/div[1]/section/section/main/div/div[2]/div[2]/div[2]/div/div/div/div/div/div[2]/table/tbody/tr[2]/td[12]/button[3]")).click();
